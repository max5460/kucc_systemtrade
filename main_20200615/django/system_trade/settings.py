"""
Django settings for system_trade project.
...
SECRET_KEY = 'ii^11ai+pf8r8w3$&@b#cgwlr$@z#c((&(9)vg$r&mto!a%&t@'
...
ROOT_URLCONF = 'system_trade.urls'
...
WSGI_APPLICATION = 'system_trade.wsgi.application'
